...
import com.haha.mapper.MiddleRankMapper;
 ...
 * 页面下载地址https://www.op.gg/champions?region=global&tier=platinum_plus&position=middle
 * 页面存放位置：pages/middle.html
 * 具体操作如下：
 * 1.进入网站，F12查看元素，选中需要的<table>标签,复制元素到pages/middle.html
 * 2.运行
 *
 * @author sloth
 * @deprecated
...
public class GetMiddle {
    public static void main(String[] args) throws Exception {
        ...
        BufferedReader reader = new BufferedReader(new FileReader(
                "D:\\Projects\\SpringCloud01\\crawler\\src\\main\\resources\\pages\\middle.html"));
...
//            insert(rank);
    ...
    public static void insert(Rank rank) throws Exception {
        ...
        try (SqlSession sqlSession = sqlSessionFactory.openSession(true)) {
            MiddleRankMapper mapper = sqlSession.getMapper(MiddleRankMapper.class);
            mapper.insert(rank);
        }
    }
