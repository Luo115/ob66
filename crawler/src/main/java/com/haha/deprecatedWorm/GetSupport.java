...
import com.haha.mapper.SupportRankMapper;
 ...
 * 页面下载地址https://www.op.gg/champions?region=global&tier=platinum_plus&position=support
 * 页面存放位置：pages/support.html
 * 具体操作如下：
 * 1.进入网站，F12查看元素，选中需要的<table>标签,复制元素到pages/support.html
 * 2.运行
 *
 * @author sloth
 * @deprecated
...
public class GetSupport {
    public static void main(String[] args) throws Exception {
        ...
        BufferedReader reader = new BufferedReader(new FileReader(
                "D:\\Projects\\SpringCloud01\\crawler\\src\\main\\resources\\pages\\support.html"));
...
//            insert(rank);
    ...
    public static void insert(Rank rank) throws Exception {
        ...
        try (SqlSession sqlSession = sqlSessionFactory.openSession(true)) {
            SupportRankMapper mapper = sqlSession.getMapper(SupportRankMapper.class);
            mapper.insert(rank);
        }
    }
