...
import com.haha.mapper.BottomRankMapper;
 ...
 * 页面下载地址https://www.op.gg/champions?region=global&tier=platinum_plus&position=bottom
 * 页面存放位置：pages/bottom.html
 * 具体操作如下：
 * 1.进入网站，F12查看元素，选中需要的<table>标签,复制元素到pages/bottom.html
 * 2.运行
 *
 * @author sloth
 * @deprecated
 */
public class GetBottom {
    public static void main(String[] args) throws Exception {
        //获取网页
        BufferedReader reader = new BufferedReader(new FileReader(
                "D:\\Projects\\SpringCloud01\\crawler\\src\\main\\resources\\pages\\bottom.html"));
...
//            insert(rank);
    ...
    public static void insert(Rank rank) throws Exception {
        ...
        try (SqlSession sqlSession = sqlSessionFactory.openSession(true)) {
            BottomRankMapper mapper = sqlSession.getMapper(BottomRankMapper.class);
            mapper.insert(rank);
        }
    }
